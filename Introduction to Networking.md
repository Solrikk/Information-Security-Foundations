...
![Диаграмма передачи пакетов, показывающая инкапсуляцию данных от отправителя к получателю через уровни: Данные, TCP, IP, MAC и Двоичная передача, с соответствующими заголовками и последовательностью.](https://academy.hackthebox.com/storage/modules/34/redesigned/packet_transfer.png)

...
![Циклическая диаграмма, показывающая четыре шага: 1. Входной трафик, 2. Уменьшение шума фильтрацией, 3. Анализ и исследование, 4. Обнаружение и оповещение.](https://academy.hackthebox.com/storage/modules/34/redesigned/workflow.png)

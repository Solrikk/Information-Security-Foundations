...
![Таблица метрик оценки CVSS, показывающая базовые, временные и экологические метрики оценки с различными факторами воздействия и эксплуатируемости](https://academy.hackthebox.com/storage/modules/75/cvssv3_calc.webp)

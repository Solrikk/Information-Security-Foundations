...
**К какой из вышеуказанных категорий относится публичная уязвимость 'CVE-2014-6271'?**

*Подсказка: Это одна из вышеуказанных! Просто найдите описание уязвимости и прочитайте о ней, и вы узнаете ответ.*

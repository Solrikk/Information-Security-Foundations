...
В этом модуле мы изучили некоторые, но далеко не все основы веб-приложений. Теперь у нас должно быть фундаментальное понимание того, как создается веб-приложение, как оно работает, и какие опасности оно может привнести в корпоративную среду.

Важно применить практический подход для дальнейшего развития нашего понимания и применения тем, изученных в этом модуле. Мы рекомендуем изучать материал в сочетании с разработкой небольшого веб-приложения. Некоторые следующие шаги, которые можно предпринять:

| **Шаг** | **К выполнению** |
|---------|------------------|
| `1.` | Настроить виртуальную машину с веб-сервером |
| `2.` | Создать `HTML` страницу |
| `3.` | Оформить её с помощью `CSS` |
| `4.` | Добавить простые функции с помощью `JavaScript` |
| `5.` | Запрограммировать простое веб-приложение |
| `6.` | Подключить ваше веб-приложение к базе данных |
| `7.` | Поэкспериментировать с API |
| `8.` | Протестировать ваше приложение на различные уязвимости и дыры в безопасности |
| `9.` | Попытаться скорректировать ваш код и конфигурации для закрытия уязвимостей |

Разработка небольшого веб-приложения обеспечит гораздо более глубокое понимание структуры и функциональности. Изучение того, как настроить и управлять таким веб-сервером, роль базы данных, и как отдельные части кода связаны между собой, является бесценным опытом.

Модули Академии `Web Requests` и `JavaScript Deobfuscation` помогут развить знания, представленные в этом модуле.

Модуль `Hacking WordPress` и другие подобные модули, связанные с `OWASP Top 10` (такие как `SQL Injection Fundamentals`), являются отличными следующими шагами для погружения в тестирование на проникновение веб-приложений и изучения большего о уязвимостях веб-приложений и их эксплуатации. Наконец, чтобы применить то, что мы изучили из этих модулей, мы можем перейти к атаке некоторых `Easy` боксов на [HackTheBox](https://www.hackthebox.eu/).

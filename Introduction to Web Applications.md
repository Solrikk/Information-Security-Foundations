...
![Screenshot of HTML and JavaScript code in a text editor.](https://academy.hackthebox.com/storage/modules/75/view_source1.webp)
...
![Login form with fields for username and password, and a login button.](https://academy.hackthebox.com/storage/modules/75/web_apps_login_form_.webp)
...
Ответьте на вопрос(ы) ниже, чтобы завершить этот раздел и заработать кубы!

**Цель(и):** Нажмите здесь, чтобы запустить целевую систему!

**+1 куб** Проверьте вышеуказанную форму входа на наличие открытых паролей. Отправьте пароль в качестве ответа.

**Подсказка:** Используйте ctrl+u для показа исходного кода в Firefox, или щелкните правой кнопкой мыши > Просмотр исходного кода страницы
...
**Уязвимости Front End**
- **Раскрытие конфиденциальных данных** (текущая страница)
- HTML инъекция
...
- Веб-серверы
- Базы данных
- Фреймворки разработки и API

**Уязвимости Back End**
- Общие веб-уязвимости

...
![Диаграмма, показывающая сервер, подключенный к трем клиентам: смартфону, ноутбуку и монитору.](https://academy.hackthebox.com/storage/modules/75/client-server-model.jpg)
